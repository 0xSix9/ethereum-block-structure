...
This repository provides a clear breakdown of the internal structure of an Ethereum block — the fundamental unit that makes up the Ethereum blockchain.
...
4. [State Root](./header/state-root.md)
5. [Transactions Root](./header/transactions-root.md)
6. [Receipts Root](./header/receipts-root.md)
7. [Logs Bloom](./header/logs-bloom.md)
8. [Difficulty](./header/difficulty.md)
9. [Block Number](./header/block-number.md)
10. [Gas Limit](./header/gas-limit.md)
11. [Gas Used](./header/gas-used.md)
12. [Timestamp](./header/timestamp.md)
13. [Extra Data](./header/extra-data.md)
14. [PrevRandao](./header/prev-randao.md)
15. [Nonce](./header/nonce.md)
